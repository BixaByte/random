  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          utils.poppinsMediumText('x' + widget.orderItems!.quantity!, 14.0, AppColors.blackColor, TextAlign.start),
          utils.poppinsMediumText(setText(widget.orderItems!), 12.0, AppColors.blackColor, TextAlign.start),
        ],
      ),
    );
  }

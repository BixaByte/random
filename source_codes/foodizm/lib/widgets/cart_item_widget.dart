...
class CartItemWidget extends StatefulWidget {
  ...
  const CartItemWidget({Key? key, this.cartModel, this.function}) : super(key: key);
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Row(
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            if (int.parse(widget.cartModel!.quantity!) > 1) {
                                              widget.cartModel!.quantity = (int.parse(widget.cartModel!.quantity!) - 1).toString();
                                              widget.function!(widget.cartModel!.quantity!, 'sub', widget.cartModel!.newPrice!);
                                              setState(() {});
                                            }
                                          },
                                          child: Icon(
                                      ...
                                      utils.poppinsSemiBoldText(widget.cartModel!.quantity!, 16.0, AppColors.blackColor, TextAlign.center),
                                      Container(
                                        margin: EdgeInsets.only(left: 5),
                                        child: InkWell(
                                          onTap: () {
                                            widget.cartModel!.quantity = (int.parse(widget.cartModel!.quantity!) + 1).toString();
                                            widget.function!(widget.cartModel!.quantity, 'add', widget.cartModel!.newPrice!);
                                            setState(() {});
                                          },
                                          child: Icon(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      widget.function!(widget.cartModel!.timeAdded!, 'delete', '0');
                                    },
                                    child: Padding(
